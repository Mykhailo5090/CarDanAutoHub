...
const AboutUs = () => {
  ...
  const securityLayers = [
    { title: "AES-256 Pipeline", detail: "All user requests, internal vehicle logs, and custom parsing streams are guarded by military-grade transport layer encryption." },
    { title: "VIN Integrity Scan", detail: "Automated cross-referencing with international databases to instantly flag hidden structural damages or mileage rollbacks." },
    { title: "Decentralized Ledger", detail: "Your saved vehicle portfolios and financial calculations are stored in isolated node environments ensuring absolute privacy." }
  ];

  return (
    <div className="__container_profilepage about_page_container">
      <div className="sub-body profile_sub-body about_sub_body">
        <div className="sub-body__2 profile_sub-body__2 about_sub_body__2">
          ...
          <div className="about_grid_layout">
            ...
            <div className="about_section_row section_layout_1">
              <div className="left_vertical_col">
                <div className="container_profile about_text_card tall_card __shadows">
                  ...
                  <h2>Our Vision</h2>
                  <p>
                    Welcome to CarDan AutoHub, a premium digital ecosystem where unbridled 
                    automotive passion seamlessly converges with next-generation web automation tech. 
                    We have radically redefined the boundaries of vehicle market analysis, creating an elite 
                    hub tailored for smart buyers, private collectors, and digital-first enthusiasts alike.
                    Our ultimate mission is to remove human error from the procurement cycle entirely.
                  </p>
              ...
              <div className="right_staggered_col">
                <div className="about_image_container wrapper_side anim_from_right" ref={addToRefs}>
                  <img src={porscheSide} alt="Porsche Side View" className="porsche_img img_natural_side" />
                </div>
                <div className="container_profile about_text_card sub_horizontal_card __shadows">
                  <p>
                    By blending luxury aesthetics with raw mathematical execution, we offer an interface 
                    that feels like driving a supercar—effortless, precise, and breathtakingly fast. 
                    We believe that tracking, securing, and insuring your vehicle should not require 
                    days of administrative friction, but a single, perfectly executed algorithmic cycle.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about_section_row section_layout_2">
              <div className="image_sidebar_col">
                <div className="about_image_container wrapper_top_down anim_from_bottom" ref={addToRefs}>
                  <img src={porscheTopDown} alt="Porsche Top Down" className="porsche_img img_blend_black" />
                </div>
              </div>
              ...
              <div className="main_content_col">
                <div className="container_profile about_text_card wide_card __shadows">
                  ...
                  <p>
                    Speed and absolute system uptime are engineered deep into our core architecture. 
                    Our environment processes intricate real-time requests across multiple insurance structures, 
                    verifying licenses and generating personalized dynamic offers instantly.
                  </p>
                  ...
                  <div className="insurance_interactive_pills">
                    {Object.keys(featuresData).map((key) => (
                      ...
                      >
                        {key === 'scrapers' ? '🚀 Core Scrapers' : key === 'insurance' ? '🛡️ Insure API' : '📊 Market AI'}
                      </button>
                    ))}
                  </div>
                  ...
                  <div className="interactive_display_box">
                    <div className="terminal_header">
                      ...
                      <span className="terminal_status">STATUS: OPERATIONAL [ {featuresData[activeFeature].metric} ]</span>
                    </div>
            ...
            <div className="about_section_row section_layout_3">
              <div className="main_content_col">
                <div className="container_profile about_text_card wide_card __shadows">
                  ...
                  <p>
                    Your automotive assets and search streams deserve the highest tier of structural protection. 
                    We handle the complex, dark layers of data validation, legal registry handshakes, and 
                    cross-border compliance checks so you can enjoy pure operational freedom.
                  </p>
              ...
              <div className="image_sidebar_col">
                <div className="about_image_container wrapper_top_up anim_from_top" ref={addToRefs}>
                  <img src={porscheTopUp} alt="Porsche Top Up" className="porsche_img" />
                </div>
              </div>
            </div>

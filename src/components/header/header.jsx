...
import { NavLink, useNavigate, useLocation } from 'react-router-dom'; // Додали useLocation
...
const Header = () => {
  ...
  const location = useLocation(); // Отримуємо поточний шлях сайту
  ...
  const isProfileActive = ['/profile', '/login', '/registration'].includes(location.pathname);
